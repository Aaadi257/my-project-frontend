...
const ScorecardForm = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        bad_order_amritsari_swiggy: '',
        bad_order_chennai_zomato: '',
        bad_order_chennai_swiggy: '',

        delay_order_amritsari_zomato: '',
        delay_order_amritsari_swiggy: '',
        delay_order_chennai_zomato: '',
        ...
        try {
            ...
            const payload = {
                ...
                metrics: {
                    ...
                    bad_order_amritsari_swiggy: parseFloat(formData.bad_order_amritsari_swiggy) || 0,
                    bad_order_chennai_zomato: parseFloat(formData.bad_order_chennai_zomato) || 0,
                    bad_order_chennai_swiggy: parseFloat(formData.bad_order_chennai_swiggy) || 0,

                    delay_order_amritsari_zomato: parseFloat(formData.delay_order_amritsari_zomato) || 0,
                    delay_order_amritsari_swiggy: parseFloat(formData.delay_order_amritsari_swiggy) || 0,
                    delay_order_chennai_zomato: parseFloat(formData.delay_order_chennai_zomato) || 0,
    ...
    return (
        <div className="container animate-fade-in">
            ...
            <form onSubmit={handleSubmit} className="card">
                ...
                <MetricSection title="Bad Order %">
                    <InputGroup label="Amritsari Zomato %" name="bad_order_amritsari_zomato" value={formData.bad_order_amritsari_zomato} onChange={handleChange} />
                    <InputGroup label="Amritsari Swiggy %" name="bad_order_amritsari_swiggy" value={formData.bad_order_amritsari_swiggy} onChange={handleChange} />
                    <InputGroup label="Chennai Zomato %" name="bad_order_chennai_zomato" value={formData.bad_order_chennai_zomato} onChange={handleChange} />
                    <InputGroup label="Chennai Swiggy %" name="bad_order_chennai_swiggy" value={formData.bad_order_chennai_swiggy} onChange={handleChange} />
                </MetricSection>

                <MetricSection title="Delay Order %">
                    <InputGroup label="Amritsari Zomato %" name="delay_order_amritsari_zomato" value={formData.delay_order_amritsari_zomato} onChange={handleChange} />
                    <InputGroup label="Amritsari Swiggy %" name="delay_order_amritsari_swiggy" value={formData.delay_order_amritsari_swiggy} onChange={handleChange} />
                    <InputGroup label="Chennai Zomato %" name="delay_order_chennai_zomato" value={formData.delay_order_chennai_zomato} onChange={handleChange} />
                    <InputGroup label="Chennai Swiggy %" name="delay_order_chennai_swiggy" value={formData.delay_order_chennai_swiggy} onChange={handleChange} />
                </MetricSection>

                <MetricSection title="Outlet Audit (Mistakes)">
                    <InputGroup label="Amritsari Mistakes (count)" name="mistakes_amritsari" value={formData.mistakes_amritsari} onChange={handleChange} type="number" step="1" />
                    <InputGroup label="Chennai Mistakes (count)" name="mistakes_chennai" value={formData.mistakes_chennai} onChange={handleChange} type="number" step="1" />
                </MetricSection>

                <MetricSection title="Add On Sale">
                    <InputGroup label="Amritsari Total Sale" name="total_sale_amritsari" value={formData.total_sale_amritsari} onChange={handleChange} />
                    <InputGroup label="Amritsari Add-on Sale" name="add_on_sale_amritsari" value={formData.add_on_sale_amritsari} onChange={handleChange} />
                    <InputGroup label="Chennai Total Sale" name="total_sale_chennai" value={formData.total_sale_chennai} onChange={handleChange} />
                    <InputGroup label="Chennai Add-on Sale" name="add_on_sale_chennai" value={formData.add_on_sale_chennai} onChange={handleChange} />
                </MetricSection>
